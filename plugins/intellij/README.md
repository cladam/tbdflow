...
This plugin integrates the `tbdflow` CLI directly into your JetBrains IDE, providing a seamless, guided workflow for Trunk-Based Development.
...
- **Guided Commit Dialog**: A custom commit dialog that helps you build perfect Conventional Commit messages with fields for type, scope, body, and breaking changes.
